...
namespace DevilDesireDevLib.Implementation.Tools
{
    public class GridUtils
    {
        ...
        private static void OnRowDefinitionsPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (targetGrid == null)
            {
                throw new ArgumentException("Das Targetgrid darf nicht NULL sein.");
            }
            ...
            if (rowDefs == null)
            {
                throw new ArgumentException("Die Rowdefinitions dürfen nicht NULL sein.");
            }
        ...
        private static void OnColumnDefinitionsPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (columnDefs == null)
            {
                throw new ArgumentException("Die Columndefinitions dürfen nicht NULL sein.");
            }

            string[] columnDefArray = columnDefs.Split(',');
